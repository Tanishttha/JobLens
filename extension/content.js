...
function showPanel(text) {
  ...
  const url = `https://job-lensai.vercel.app/?selection=${encodeURIComponent(text)}`;
  try {
...
// The iframe (https://job-lensai.vercel.app) cannot call chrome.storage directly since
