...
function showPanel(text) {
  ...
  const url = `https://fake-jobdetect.vercel.app/?selection=${encodeURIComponent(text)}`;
  try {
...
// The iframe (https://fake-jobdetect.vercel.app) cannot call chrome.storage directly since
